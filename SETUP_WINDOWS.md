...
`brms` is optional and requires an appropriate Stan toolchain. EyeLink
EDF files require SR Research’s local `edf2asc` converter; ASC and Data
Viewer exports can be read without that bridge.
...
Add only de-identified exports, complete the generated manifest, and run
the repository-level `validate_real_exports.R` script. Keep the corpus
outside public version control and manually review every generated
