...
Item selection can be treated as a constrained multi-objective decision
rather than a sequence of isolated cutoffs.
...
Process-DIF is reported separately from psychometric DIF and can be
monitored over deployment batches.
...
Conditional centiles are reference distributions, not clinical
classifications.
