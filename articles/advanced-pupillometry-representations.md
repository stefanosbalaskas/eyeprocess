...
exposes transparent velocity, low/high-frequency contrast, and
RIPA-style proxy representations. The package deliberately avoids
presenting these as pure cognitive-load measures.
...
Adjusted values remain model-dependent and should be described as
luminance/fatigue-adjusted, not as cognition isolated from all
confounding.
