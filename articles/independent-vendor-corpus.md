...
3.  `empirically-validated`: independent real exports with version
    metadata, licensing review, validation artifacts, and successful
    audits pass.
...
A production claim should remain version-specific and should identify
unsupported semantics rather than presenting a binary vendor badge.
