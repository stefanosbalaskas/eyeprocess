...
The adapter layer converts source-specific exports into explicit
canonical records, streams, samples, eye samples, episodes, events,
intervals, AOIs, biometrics, quality results, and provenance.
...
No coordinate conversion, interpolation, resampling, or event
reclassification should occur silently.
