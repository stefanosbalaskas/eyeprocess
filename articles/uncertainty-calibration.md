...
The uncertainty programme separates calibration, AOI assignment,
preprocessing, sampling, and model components. It produces a
source-by-metric budget and can propagate the combined uncertainty to a
study estimand.
...
Spatial drift should be reviewed before derived AOI metrics are
interpreted.
...
Recalibration must be estimated from defensible reference points and
audited on held-out targets whenever possible.
