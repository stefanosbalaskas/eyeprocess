...
Pupil diameter is treated as a physiological time series. It is not
automatically labelled cognitive load, effort, surprise, or arousal. The
model preserves preprocessing choices and includes nuisance adjustment
before any substantive interpretation.
...
The Stan engine jointly models the binary item outcome and pupil
trajectory using shared person/item effects, functional bases, luminance
and gaze-position covariates, and optional AR(1) residual structure.
...
Scalar peak or area-under-the-curve summaries are retained as
transparent baselines rather than assumed to be inferior.
...
Promotion requires recovery under autocorrelation, luminance
confounding, blink/interpolation variation, baseline uncertainty, and
