...
converts sample-level gaze/pupil streams into a standardized participant
x trial x time-window representation while retaining the window
specification as provenance.
...
A sensitivity audit helps detect results driven by arbitrary window
choices.
...
Linear/quadratic/cubic coefficients summarize temporal shape; they are
not causal or latent-strategy parameters by themselves.
