...
#' @return A tabular R object containing find process measures by channel, level, status, or text; rows represent analysis units and columns contain the returned quantities.
#' @export
