...
#' @return A tabular R object containing an explicit process-analysis sensitivity grid; rows represent analysis units and columns contain the returned quantities.
#' @export
...
#' @return A tabular R object containing ordered specification-curve data; rows represent analysis units and columns contain the returned quantities.
#' @export
...
#' @param x Sensitivity result.
#' @param effect Effect column.
#' @return A tabular R object containing decision leverage of each analytical choice; rows represent analysis units and columns contain the returned quantities.
#' @export
