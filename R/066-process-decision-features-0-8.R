...
#' @return An R object containing process-feature stability across repeated analyses. The concrete class and structure follow the selected method, engine, or input object and are preserved as documented by that workflow.
#' @export
