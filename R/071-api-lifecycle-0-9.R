...
#' @param registry Lifecycle registry.
#' @return A tabular R object containing return superseded/deprecated compatibility interfaces; rows represent analysis units and columns contain the returned quantities.
#' @export
...
#' @param registry Lifecycle registry.
#' @return A tabular R object containing canonical API mapping; rows represent analysis units and columns contain the returned quantities.
#' @export
