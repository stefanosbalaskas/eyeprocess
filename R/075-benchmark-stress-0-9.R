...
#' @return An R object containing define a computational benchmark design. The concrete class and structure follow the selected method, engine, or input object and are preserved as documented by that workflow.
#' @export
...
#' @param seed Seed.
#' @return An R object containing inject trial/row imbalance by dropping observations. The concrete class and structure follow the selected method, engine, or input object and are preserved as documented by that workflow.
#' @export
