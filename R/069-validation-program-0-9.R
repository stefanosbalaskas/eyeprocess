...
#' @return An R object containing expand a process-validation design into explicit conditions. The concrete class and structure follow the selected method, engine, or input object and are preserved as documented by that workflow.
#' @export
...
#' @return An R object containing parameter-recovery table. The concrete class and structure follow the selected method, engine, or input object and are preserved as documented by that workflow.
#' @export
...
#' @param by Optional grouping variables.
#' @return An R object containing interval-coverage table. The concrete class and structure follow the selected method, engine, or input object and are preserved as documented by that workflow.
#' @export
...
#' @return A numeric value or vector containing rank validation conditions by a transparent robustness score.
#' @export
...
#' @param x Validation result.
#' @return An R object containing overall validation robustness score. The concrete class and structure follow the selected method, engine, or input object and are preserved as documented by that workflow.
#' @export
