...
parameters as truth. Channel-specific dropout is applied only after the
complete generative data have been created.
...
- sd_person:
  ...
  Person-side standard deviations for ability, speed, and gaze-process
  propensity.
...
- gaze_shape:
  ...
  Shape/scale parameters for inverse-gamma generation of
