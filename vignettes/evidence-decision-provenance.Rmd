---
title: "Evidence and Decision Provenance"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Evidence and Decision Provenance}
...
The evidence graph links raw data, transformations, metrics, models, diagnostics, and decisions. The graph is deliberately explicit: its edges document declared dependencies rather than inferring causal relationships.
...
Graph comparison reveals exactly which evidence or dependencies changed between analysis versions.
